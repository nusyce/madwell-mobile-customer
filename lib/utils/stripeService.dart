...
class StripeService {
  ...
  static Future<StripeTransactionResponse> payWithPaymentSheet({
    ...
    final String? awaitedTransactionID,
  }) async {
    try {
      ...
      final Map<String, dynamic>? paymentIntent =
        ...
        awaitedTransactionID: awaitedTransactionID,
      );
  ...
  static Future<Map<String, dynamic>?> createPaymentIntent({
    ...
    try {
      ...
      if (from == "additionalCharge") {
        parameter['metadata[order_id]'] = awaitedOrderID;
        parameter['metadata[additional_charges_transaction_id]'] =
            awaitedTransactionID;
      }
      final Dio dio = Dio();
